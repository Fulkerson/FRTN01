...
on malformed configuration file. This is accomplished by updating the
parameters any time the unix signal USR1 is issued to the client. A
external python process is used to monitor the configuration file and
client process. The monitoring is done using inotify.
