...
_SENSOR = descriptor.EnumDescriptor(
  ...
  values=[
    descriptor.EnumValueDescriptor(
      ...
      type=None),
    descriptor.EnumValueDescriptor(
      name='LEVEL', index=1, number=2,
      options=None,
      type=None),
    descriptor.EnumValueDescriptor(
      name='IN_PUMP_RATE', index=2, number=3,
      options=None,
      type=None),
    descriptor.EnumValueDescriptor(
      name='OUT_PUMP_RATE', index=3, number=4,
      options=None,
      type=None),
    descriptor.EnumValueDescriptor(
      name='HEATER_RATE', index=4, number=5,
      options=None,
      type=None),
    descriptor.EnumValueDescriptor(
      name='MIXER_RATE', index=5, number=6,
      options=None,
      type=None),
    descriptor.EnumValueDescriptor(
      name='COOLER_RATE', index=6, number=7,
      options=None,
      type=None),
  ],
...
_OUTPUT = descriptor.EnumDescriptor(
  ...
  values=[
    descriptor.EnumValueDescriptor(
      name='HEATER', index=0, number=1,
      options=None,
      type=None),
    descriptor.EnumValueDescriptor(
      name='COOLER', index=1, number=2,
      options=None,
      type=None),
    descriptor.EnumValueDescriptor(
      name='IN_PUMP', index=2, number=3,
      options=None,
      type=None),
    descriptor.EnumValueDescriptor(
      name='OUT_PUMP', index=3, number=4,
      options=None,
      type=None),
    descriptor.EnumValueDescriptor(
      name='MIXER', index=4, number=5,
      options=None,
      type=None),
  ],
  containing_type=None,
